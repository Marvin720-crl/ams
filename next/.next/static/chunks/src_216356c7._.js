...
"[project]/src/app/actions/data:1124cf [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$data$3a$1124cf__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/app/actions/data:1124cf [app-client] (ecmascript) <text/javascript>");
...
function AttendanceReportPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AttendanceReportPage.useEffect": ()=>{
            const fetchData = {
                "AttendanceReportPage.useEffect.fetchData": async ()=>{
                    setLoading(true);
                    try {
                        const [attendances, users, subjects, labs] = await Promise.all([
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$data$3a$c54bff__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getAttendancesAction"])(),
                            ...
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$data$3a$1daf85__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getSubjectsAction"])(),
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$data$3a$1124cf__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getLabsAction"])()
                        ]);
                        const populatedRecords = attendances.map({
                            "AttendanceReportPage.useEffect.fetchData.populatedRecords": (att)=>{
                                const student = users.find({
                                    "AttendanceReportPage.useEffect.fetchData.populatedRecords.student": (u)=>u.id === att.studentId
                                }["AttendanceReportPage.useEffect.fetchData.populatedRecords.student"]);
                                const subject = subjects.find({
                                    "AttendanceReportPage.useEffect.fetchData.populatedRecords.subject": (s)=>s.id === att.subjectId
                                }["AttendanceReportPage.useEffect.fetchData.populatedRecords.subject"]);
                                // This part needs more info if we want to link attendance to a specific lab request to find the lab
                                return {
                                    ...att,
                        ...
                        }["AttendanceReportPage.useEffect.fetchData.populatedRecords"]).sort({
                            "AttendanceReportPage.useEffect.fetchData.populatedRecords": (a, b)=>new Date(b.date).getTime() - new Date(a.date).getTime()
                        }["AttendanceReportPage.useEffect.fetchData.populatedRecords"]);
            ...
            }["AttendanceReportPage.useEffect.fetchData"];
            fetchData();
        }
    }["AttendanceReportPage.useEffect"], []);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(AttendanceReportPage, "liZ6qUnz5IIMkNyJ8/NqI11oW9Q=");
_c = AttendanceReportPage;
var _c;
__turbopack_context__.k.register(_c, "AttendanceReportPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_216356c7._.js.map