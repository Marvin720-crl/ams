...
function useUser() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useUser.useEffect": ()=>{
            const checkUser = {
                "useUser.useEffect.checkUser": ()=>{
                    ...
                    if (stored) {
                        ...
                        const p = users.find({
                            "useUser.useEffect.checkUser.p": (item)=>item.uid === u.uid || item.email === u.email
                        }["useUser.useEffect.checkUser.p"]);
                        setProfile(p || u);
                    } else {
                        setUser(null);
                        setProfile(null);
            ...
            return ({
                "useUser.useEffect": ()=>window.removeEventListener('storage', checkUser)
            })["useUser.useEffect"];
        }
    }["useUser.useEffect"], []);
    return {
...
function useCollection(queryObj) {
    _s1();
    ...
    const queryKey = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useCollection.useMemo[queryKey]": ()=>JSON.stringify(queryObj)
    }["useCollection.useMemo[queryKey]"], [
        queryObj
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useCollection.useEffect": ()=>{
            ...
            if (parsedQuery.teacherId) {
                filtered = filtered.filter({
                    "useCollection.useEffect": (i)=>i.teacherId === parsedQuery.teacherId
                }["useCollection.useEffect"]);
            }
            if (parsedQuery.studentId && key === 'enrollments') {
                filtered = filtered.filter({
                    "useCollection.useEffect": (i)=>i.studentId === parsedQuery.studentId
                }["useCollection.useEffect"]);
            }
            setData(filtered);
            setLoading(false);
...
_s1(useCollection, "wT08JJo0Bg7bEnU87e5gziYZTII=");
function useDoc(docPath) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useDoc.useEffect": ()=>{
            ...
            setData(items.find({
                "useDoc.useEffect": (i)=>i.uid === id || i.id === id
            }["useDoc.useEffect"]) || null);
            setLoading(false);
        }
    }["useDoc.useEffect"], [
        docPath
...
_s2(useDoc, "Zn4cs3026OJRBhxLd0Oqj+bUOXY=");
;
;
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
...
__turbopack_context__.s([
    ...
    "useDoc",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["useDoc"],
    "useFirebase",
...
//# sourceMappingURL=src_1b61c221._.js.map