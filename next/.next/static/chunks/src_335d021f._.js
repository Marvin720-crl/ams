...
function FirebaseClientProvider(param) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FirebaseClientProvider.useEffect": ()=>{
            const { app, firestore, auth } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["initializeFirebase"])();
            setInstances({
                app,
                firestore,
                auth
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useUser.useEffect": ()=>{
            const unsubscribeAuth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onAuthStateChanged"])(auth, {
                "useUser.useEffect.unsubscribeAuth": (currentUser)=>{
                    setUser(currentUser);
                    if (!currentUser) {
                        setProfile(null);
                        setLoading(false);
            ...
            }["useUser.useEffect.unsubscribeAuth"]);
            return ({
                "useUser.useEffect": ()=>unsubscribeAuth()
            })["useUser.useEffect"];
        }
...
_s(useUser, "mC576aFo1eJuiYzm7mhGSmv6ZM8=", false, function() {
    return [
...
class FirestorePermissionError extends Error {
    constructor(context){
        super("Missing or insufficient permissions at ".concat(context.path, " during ").concat(context.operation)), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "context", void 0);
            ...
            const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(query, {
                "useCollection.useEffect.unsubscribe": (snapshot)=>{
                    const items = snapshot.docs.map({
                        "useCollection.useEffect.unsubscribe.items": (doc)=>({
                                ...doc.data(),
                                id: doc.id
                            })
                    }["useCollection.useEffect.unsubscribe.items"]);
                    setData(items);
                    setLoading(false);
                }
...
function initializeFirebase() {
    if (!app) {
        app = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initializeFirebaseApp"])();
...
__turbopack_context__.s([
    ...
    "getAuth",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getAuth"],
    "getFirebaseApp",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getFirebaseApp"],
    "getFirestore",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getFirestore"],
    "initializeFirebase",
...
//# sourceMappingURL=src_335d021f._.js.map