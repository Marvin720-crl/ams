...
export async function ensureDbStructure() {
  try {
    ...
    const files = ['users.json', 'subjects.json', 'enrollments.json', 'attendance.json', 'labs.json', 'pcs.json', 'labrequests.json', 'auditlog.json', 'settings.json', 'books.json', 'libraryborrowings.json', 'rooms.json', 'reservations.json', 'borrowrequests.json'];
