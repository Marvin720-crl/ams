...
export default function SubjectDetailsStudent({ subject, onBack }: SubjectDetailsStudentProps) {
  ...
  const qrValue = `${user.id}|${subject.id}`;
          ...
          <Dialog>
            ...
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Have your teacher scan this QR code to mark your attendance for {subject.name}.
                    </DialogDescription>
                </DialogHeader>
          ...
          <Card className="border-primary/5 shadow-2xl rounded-[2.5rem] overflow-hidden bg-white">
            ...
            <CardContent className="p-8 space-y-6">
              ...
              <div>
                ...
                <p className="font-black text-2xl tracking-tight text-primary">{subject.day} • {subject.startTime}</p>
              </div>
            </CardContent>
          </Card>
