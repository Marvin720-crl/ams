  ...
  const loadSubjectsForTeacher = async (teacherId: string) => {
    ...
    if (teacherId === 'admin') {
      const adminSubjects: Subject[] = [
        { id: 'exam', name: 'Exam', teacherId: 'admin', teacherName: 'Admin', schedules: [] },
        { id: 'personal_use', name: 'Personal Use', teacherId: 'admin', teacherName: 'Admin', schedules: [] }
      ];
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-lg p-8 space-y-6">
        ...
        <div>
            ...
            <textarea
              ...
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#b40000] focus:border-transparent outline-none"
              rows={3}
              placeholder={formData.subject === 'personal_use' ? 'Please provide a reason for your request...' : 'Optional'}
