  ...
  const handleApprove = async (request: LabRequest) => {
    try {
      ...
      const attendanceEntry = {
        ...
        timeIn: new Date(request.startTime).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit'}),
        timeOut: new Date(request.endTime).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit'}),
