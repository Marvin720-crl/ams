...
export default function ChatWindow({ conversation, messages, users, onSend, onToggleSidebar }: ChatWindowProps) {
    ...
    return (
        <div className="flex-1 flex flex-col h-full bg-[#38364C] overflow-hidden">
            {/* Chat Header */}
            <div className="h-16 px-4 md:px-6 shadow-md border-b border-white/5 flex items-center justify-between bg-[#38364C]/95 backdrop-blur-md sticky top-0 z-10">
            ...
            {/* Input Area */}
            <div className="p-4 md:p-8 bg-[#38364C]">
                <div className="bg-white/5 rounded-[1.5rem] px-4 py-2 flex items-center gap-3 md:gap-4 border border-white/5 focus-within:ring-2 focus-within:ring-primary/20 transition-all shadow-2xl">
                    ...
                    <div className="flex items-center gap-1">
                        <Popover>
                            ...
                            <PopoverContent className="w-[300px] md:w-96 bg-[#2a2839] border-none p-6 rounded-[2.5rem] shadow-[0_32px_64px_-12px_rgba(0,0,0,0.5)] mb-4">
            ...
            <Dialog open={showNitro} onOpenChange={setShowNitro}>
                <DialogContent className="bg-[#2a2839] border-none text-white rounded-[3rem] p-10 max-w-[90vw] md:max-w-[480px] shadow-2xl">
