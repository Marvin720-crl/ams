...
export default function ChatContainer() {
  ...
  if (loading && conversations.length === 0) {
    return (
      <div className="h-[calc(100vh-180px)] flex items-center justify-center bg-[#0F1322] rounded-3xl border border-white/5 shadow-xl">
  ...
  return (
    <div className="h-[calc(100vh-180px)] bg-[#0F1322] rounded-[2rem] shadow-2xl flex overflow-hidden relative">
      {isSidebarOpen && (
        <div 
      ...
      <div className="flex-1 flex flex-col bg-[#0F1322]">
        {selectedConv ? (
          <ChatWindow
