    ...
    <div>
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-8 gap-4">
        ...
        <div className="flex flex-col sm:flex-row gap-2 w-full md:w-auto">
          <Button onClick={() => { setMode('lend'); reset(); }} variant={mode === 'lend' ? 'default' : 'secondary'} className="gap-2 w-full sm:w-auto">
            Lend Book
          </Button>
          <Button onClick={() => { setMode('return'); reset(); }} variant={mode === 'return' ? 'default' : 'secondary'} className="gap-2 w-full sm:w-auto">
            Return Book
          </Button>
        </div>
      </div>
